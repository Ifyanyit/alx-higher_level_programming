...
This is an ALX-Africa project that  involved learning Web Scraping and practicing file I/O on Node.js, and using the NPM request. 
The workflow of accessing the attributes of a simple-created JSON object by [Jimmy Tran](https://alx-intranet.hbtn.io/rltoken/zm0h7FqpQCZZpPZqxxwLxA)
